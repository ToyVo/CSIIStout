...
int writeInfo();  // This function demonstrates the use of a structure variable to store a record of information to a file.
int readInfo(); // This function demonstrates the use of a structure variable to read a record of information from a file.
