...
void PrintableCard::printCurses() const
{
	...
	switch(mSuit)
	{
		case SUIT_HEARTS: case SUIT_DIAMONDS: attron(COLOR_PAIR(RED_CARD)); break;
		case SUIT_CLUBS: case SUIT_SPADES: attron(COLOR_PAIR(BLACK_CARD)); break;
	}
	...
	{
		// Ace and face cards
		case VALUE_ACE: printw("A"); break;
		case VALUE_JACK: printw("J");  break;
		case VALUE_QUEEN: printw("Q");  break;
		case VALUE_KING: printw("K");  break;

		// Sepcial case for the two-digit card 10
		case VALUE_TEN: printw("10"); break;

		// Other Number Cards (can just use the value of the 'enum')
		case VALUE_TWO: case VALUE_THREE: case VALUE_FOUR: case VALUE_FIVE: 
		case VALUE_SIX: case VALUE_SEVEN: case VALUE_EIGHT: case VALUE_NINE: 
	...
	switch(mSuit)
	{
		...
		case SUIT_HEARTS: addch(ACS_PICK(3, 0)); break;
		case SUIT_DIAMONDS:	addch(ACS_PICK(4, 0)); break;
		case SUIT_CLUBS: addch(ACS_PICK(5, 0)); break;
		case SUIT_SPADES: addch(ACS_PICK(6, 0)); break;
