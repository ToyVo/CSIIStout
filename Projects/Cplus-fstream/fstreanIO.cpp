...
int readWrite(); // this function demonstreates reading and writing a file through an fstream object
int errorTest(); // This program demonstrates the return value of the stream object error testing member functions.
void showState(fstream &file);  
int failTest(); // This program shows the behavior of the >> operator on files that contain spaces as part of the information.
