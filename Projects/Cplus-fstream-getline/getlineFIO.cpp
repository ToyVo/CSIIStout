...
int getlineTest(); // This function uses the  getline  function to read a line of information from the file.
int getlineDelimiter(); // This function demonstrates the getline function with a user-specified delimiter.
int readOneChar(); // This program demonstrates the use of the get member functions of the istream class
