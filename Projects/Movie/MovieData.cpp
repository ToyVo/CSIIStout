...
void MovieData::setYear(int y)
{
	year = y;
}

void MovieData::setTime(double n)
{
	time = n;
}

void MovieData::setCost(double c)
{
	cost = c;
}

void MovieData::setRevenue(double r)
{
	revenue = r;
}
...
double MovieData::getCost()
{
	return cost;
}

double MovieData::getRevenue()
{
	return revenue;
}
