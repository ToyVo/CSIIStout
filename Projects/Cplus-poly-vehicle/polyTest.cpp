...
public:
	...
	{
		cout<<color<<" Car "<<registrationNumber<<" owned by: "<<owner->getName()<<" whos phone number is: "<<owner->getPhone()<<endl;
	}
};
...
public:
	...
	virtual const void printInfo()
	{
		...
		cout<<registrationNumber<<" owned by: "<<owner->getName()<<" whos phone number is: "<<owner->getPhone()<<endl;
	}
};
...
int main()
{
	...
	Vehicle * vArray[] = { new Car("1000", new Person("Cole Nuwen", "715-309-2121"), "white"),
